...
public class Cau2 {
    ...
    public static void hienThiMangDaoNguoc(int[] a,int n){
        for(int i=n-1;i>=0;i--){
            System.out.print(a[i]+ " ");
        }
        System.out.println();
    }
    public static void hienThiMangChiaHetCho_a1(int[] a,int n){
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            switch(x){
                ...
                case 5:
                    hienThiMangDaoNguoc(a,n);break;
                case 6:
                    hienThiMangChiaHetCho_a1(a,n);break;
                case 7:
                    tongSNT(a,n);break;
                case 8:
